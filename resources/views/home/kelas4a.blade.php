                ...
                <div class="row">
                    ...
                    <table id="dataTable" class="table table-bordered mb-4 table-responsive" style="border-collapse: separate; border-spacing: 0 10px;">
                        <thead class="thead-light">
                            <tr>
                                <th colspan="8" class="text-center" style="background-color: #0056b3; color: white; font-size: 18px; padding: 15px 0; border-radius: 8px;">Jadwal Pelajaran Kelas IV.A</th>
                            </tr>
                            <tr>
                                <th>No</th>
                                <th>Waktu</th>
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM jadwal_pelajaran WHERE kelas = 'IV.A'";
